...
import { useCreateCandidateMutation } from '../../../../../Redux/features/candidate/candidateApi';
import { toast } from 'sonner';
import { useGetAllElectionQuery } from '../../../../../Redux/features/election/electionApi';

export const CreateCandidateModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await createCandidate(formData).unwrap();
      if (result) {
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <h3 className="text-xl font-bold text-gray-200 mb-4">Create New Candidate</h3>
