...
import { useDeleteCandidateMutation } from '../../../../../Redux/features/candidate/candidateApi';
import { toast } from 'sonner';

export const DeleteCandidateModal = ({ isOpen, onClose, selectedCandidate }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const result = await deleteCandidate({ id: selectedCandidate.id }).unwrap();
      if (result) {
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <h3 className="text-xl font-bold text-gray-200 mb-4">Delete Candidate</h3>
